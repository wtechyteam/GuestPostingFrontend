...
const ContactUsCards = () => {
  ...
  return (
    <div className="container-xs px-5 md:px-10 mt-[2rem]">
      <div className="flex flex-row sm:flex-col sm:flex-wrap justify-between gap-5">
        {[
          {
            title: 'About',
          ...
          <div
            key={index}
            className={`flex flex-col w-1/3 sm:w-[calc(50%-10px)] lg:w-[369.98px] h-[220px] p-[20px] px-[50px] pb-[45px] 
          ...
          >
            ...
            <p className="leading-8">{card.content}</p>
          </div>
        ))}
      </div>
    </div>
