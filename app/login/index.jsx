...
export default function LoginOnePage() {
  ...
  alt="Saly Image"
  className="mt-[20px] sm:mt-[-10rem] h-auto w-[80%] md:w-[36%] self-end object-contain block" // Negative margin for small screens, width 80% on small screens, 36% on medium screens and above
/>
