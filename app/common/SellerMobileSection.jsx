...
export default function SellerMobileSection({ images, ...props }) {
  ...
  return (
    <div
      {...props}
      className="flex flex-col justify-center items-center w-full rounded-lg p-4 sm:p-12 md:p-10" // Added padding for different screen sizes
    >
      <button
        type="button"
        ...
        {images.map((image, index) => (
          ...
          >
            <Image 
              ...
              className="rounded-lg sm:w-[220px] sm:h-[300px] md:w-[280px] md:h-[600px]" // Responsive size for small/medium screens
