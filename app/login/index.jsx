...
/>
  ...
  {/* Colored div */}
  <div className="absolute bottom-0 right-[10%] top-0 my-auto h-[60px] w-[64%] bg-indigo-a400 sm:right-auto sm:left-32 sm:mx-auto sm:w-[50%] md:left-[10%] md:w-[75%]" />
    ...
    >
      ...
      <span className="font-bold underline">
        {displayedWord}
          ...
          <div className="flex w-[44%] flex-col items-center px-14 md:w-full md:px-5 md:items-center sm:w-[90%] sm:px-3 sm:mx-[2rem] sm:mt-[2rem]">
          <Text
  size="text7xl"
  as="p"
