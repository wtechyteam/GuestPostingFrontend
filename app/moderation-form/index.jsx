              ...
              <div className="mt-6 ">
                <div className="bg-gray-10 rounded-[14px] mb-[30rem] text-adsy_com-black p-6 w-[99%]">
                  <h2 className="text-lg font-semibold mb-2">
                    You have to add a minimum of 50 sites where you can place or
                    create&place content on the our platform.
                  </h2>
                  <p className="mb-4 leading-6">
                    The list of your sites is here. Choose the best sites to
                    post content on. We can make selective purchases on these
                    sites to check the / rate of placement and price matching
                    during the moderation process.
                  </p>
                  <ul className="list-disc pl-5 mb-4">
                    <li className="text-sm mb-2 leading-5">
                      While choosing a publisher for their tasks, buyers can see
                      whether a publisher has made a security deposit or not.
                      Use this to stand out from other publishers and increase
                      your chances to get new tasks from buyers.
                    </li>
                    <li className="text-sm mb-2 leading-5">
                      We will release all your sites from the “On hold” status
                      even if you decide to add over 100 of them.
                    </li>
                  </ul>
                  <div className="bg-red-100 h-40 w-[99%] mx-auto rounded-lg shadow-lg flex items-center p-4">
                    <svg
                      className="w-20 h-20 text-red-600 mr-2"
                    ...
                    <p className="mb-0 leading-6 text-gray-800">
                      You should have 50+ added and approved sites. (50+ sites
                      should be in the Approved tab in the My platforms menu. If
                      you have added enough sites, but they are in the Pending
                      specification or Pending moderation tabs, go to those
                      tabs, click the Not in inventory sign, and see what the
                      site is missing. Fix the issue so that we can check your
                      sites and move to other statuses.)
                    </p>
                  </div>
