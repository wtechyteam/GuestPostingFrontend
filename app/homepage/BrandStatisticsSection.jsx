  ...
  return (
    <>
      ...
      <div className="flex justify-center">
        <div className="container-xs flex items-start justify-center gap-9 px-4 md:flex-col md:px-5 md:mb-10 sm:mb-6 mb-0">
          {/* Image section */}
          <div className="h-[674px] relative flex-1 self-center md:w-full md:flex-none md:self-stretch">
            <Image
              ...
              height={544}
              alt="Vector Image"
              className="rounded-[56px] right-[-0.20px] bottom-[0.40px] w-[82%] h-[544px] absolute m-auto object-contain block md:hidden" // Hidden on small screens
            />
            <div className="absolute left-0 right-0 top-0 m-auto flex flex-1 items-start md:relative md:flex-col">
              <Image
                ...
                height={130}
                alt="Vector Image"
                className="rounded-[14px] z-[4] w-[18%] h-[130px] relative mt-32 object-contain block md:hidden" // Hidden on small screens
              />
              <Image
                ...
                height={580}
                alt="Intersect Image"
                className="ml-[-104px] w-[72%] h-[580px] relative self-center object-contain md:ml-0 md:w-[80%] md:h-[350px] sm:w-full sm:h-[200px]"
              />
            </div>
          </div>
          {/* Text section */}
